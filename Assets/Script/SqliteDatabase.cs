...
namespace Script
{
    ...
    public class SqliteDatabase
    {
        ...
        private static extern int sqlite3_prepare_v2(IntPtr db, string zSql, int nByte, out IntPtr ppStmpt,
            IntPtr pzTail);
        ...
        public SqliteDatabase(string dbName)
        {
            ...
            if (!System.IO.File.Exists(pathDB) || (System.IO.File.GetLastWriteTimeUtc(sourcePath) >
                                                   System.IO.File.GetLastWriteTimeUtc(pathDB)))
            {
                ...
                else
                {
                    ...
                    {
                        CanExQuery = false;
                        Debug.Log("ERROR: the file DB named " + dbName +
        ...
        private IntPtr Prepare(string query)
        {
            ...
            */
            ...
            // reference: https://shikaku-sh.hatenablog.com/entry/unity-sqliteunitykit-correction-points
            // クエリのバイト数を取得します
